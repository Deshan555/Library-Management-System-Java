 ...
 */
public class Register_Fail extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        message.setText("Register Faild !! Something Wrong");
        jPanel1.add(message, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 50, -1, 57));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Register_Fail.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Register_Fail().setVisible(true);
            }
        });
    }
