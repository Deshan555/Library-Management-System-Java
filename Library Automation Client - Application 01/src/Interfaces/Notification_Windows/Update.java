...
public class Update extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/animations/742-multimedia-code-1-outline.gif"))); // NOI18N
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 40, 140, 80));

        message.setFont(new java.awt.Font("Yu Gothic UI Semilight", 0, 24)); // NOI18N
        message.setText("CURRENT DETAILS UPDATE SUCCESSFULLY");
        jPanel1.add(message, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 50, 460, 57));
