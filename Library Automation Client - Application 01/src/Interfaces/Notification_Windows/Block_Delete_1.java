 ...
 */
public class Block_Delete_1 extends javax.swing.JFrame {

    /**
     * Creates new form Log_In_Fail
     */
    public Block_Delete_1() 
    {
        initComponents();
    ...
    private void initComponents() {
        ...
        message.setText("THAT MEMBER CAN'T REMOVE IN THIS TIME");
        jPanel1.add(message, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 40, 470, 57));
