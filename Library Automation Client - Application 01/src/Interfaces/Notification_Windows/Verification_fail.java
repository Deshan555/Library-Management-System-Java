 ...
 */
public class Verification_fail extends javax.swing.JFrame {

    /**
     * Creates new form Log_In_Fail
     */
    public Verification_fail()
    {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 20, 100, 120));

        message.setFont(new java.awt.Font("Yu Gothic UI Semilight", 0, 24)); // NOI18N
        message.setText("YOUR PAYMENT VERIFICATION FAIL");
        jPanel1.add(message, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 50, -1, 57));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Verification_fail.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
