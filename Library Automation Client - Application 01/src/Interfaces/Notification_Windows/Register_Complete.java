 ...
 */
public class Register_Complete extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/animations/1103-confetti-outline.gif"))); // NOI18N
        ...
        message.setText("REGISTER COMPLETE !! KEEP READING ");
        jPanel1.add(message, new org.netbeans.lib.awtextra.AbsoluteConstraints(186, 44, -1, 57));
        ...
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(276, 119, 150, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Register_Complete.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Register_Complete().setVisible(true);
            }
        });
    }
