...
public class Payment1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/animations/945-dividends-outline.gif"))); // NOI18N
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 40, 100, -1));

        message.setFont(new java.awt.Font("Yu Gothic UI Semilight", 0, 24)); // NOI18N
        message.setText("Payment Faild !! Something Wrong Check Again");
        jPanel1.add(message, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 60, 510, 57));
