 ...
 */
public class Wel_Come extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 20, 90, 120));

        message.setFont(new java.awt.Font("Yu Gothic UI Semilight", 0, 24)); // NOI18N
        message.setText("WEL COME TO SLTC BOOK BUCKET SYSTEM");
        jPanel1.add(message, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 50, 470, 57));
