 ...
 */
public class Log_In_Fail extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("HEY ADMIN SOMETHING WRONG , TRY AGAIN");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Log_In_Fail.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Log_In_Fail().setVisible(true);
            }
        });
    }
