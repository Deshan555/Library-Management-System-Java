 ...
 */
public class Lending_Fail extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        message.setText("Something Wrong !! Duplicate Entry Found ");
        jPanel1.add(message, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 60, -1, 57));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Lending_Fail.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Lending_Fail().setVisible(true);
            }
        });
    }
