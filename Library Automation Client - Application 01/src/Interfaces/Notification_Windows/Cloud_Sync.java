 ...
 */
public class Cloud_Sync extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/animations/loading (3).gif"))); // NOI18N
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 20, 100, 120));

        message.setFont(new java.awt.Font("Yu Gothic UI Semilight", 0, 24)); // NOI18N
        message.setText("DATA SUCCSSFULLY UPLOAD TO SERVER");
        jPanel1.add(message, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 50, 450, 57));
        ...
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 130, 110, -1));
