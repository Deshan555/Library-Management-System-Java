...
public class Sql_error extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 40, 140, 70));

        message.setFont(new java.awt.Font("Yu Gothic UI Semilight", 0, 24)); // NOI18N
        message.setText("SQL ERROR !! TRY AGAIN ");
        jPanel1.add(message, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 50, 280, 57));
