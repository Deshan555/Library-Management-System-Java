 ...
 * @author whatd
 */
public class panel_1 extends javax.swing.JInternalFrame {
    ...
    private void tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableMouseClicked
        ...
        new panel_4_1(ID).setVisible(true);
    ...
    public void search_data(String key)
    {
        ...
        String SQL = "SELECT * from audiobooks WHERE NAME LIKE '%"+key+"%' OR WRITTEN_BY LIKE '%"+key+"%' OR GENRES LIKE '%"+key+"%'";
