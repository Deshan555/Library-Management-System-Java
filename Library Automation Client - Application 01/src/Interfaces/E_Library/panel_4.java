 ...
 * @author whatd
 */
public class panel_4 extends javax.swing.JInternalFrame {
    ...
    private void tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableMouseClicked
        ...
        new panel_3_1(ID).setVisible(true);
    ...
    public void search_data(String key)
    {
        ...
        String SQL = "SELECT * from tutorials WHERE course_title LIKE '%"+key+"%' OR level LIKE '%"+key+"%' OR subject LIKE '%"+key+"%'";
