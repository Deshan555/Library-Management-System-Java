 ...
 */
public class Request_1 extends javax.swing.JFrame {
    ...
    private void jLabel8MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel8MouseClicked
        ...
        if((password_login() == 1) || (sid.getText().length() == 10) && (validation_card() == 1))
        {
            ...
            Admin screen_06 = new  Admin();
            
            pane.add(screen_06).setVisible(true);
            
            Admin_Logs.write("Access Granted - > Log In To Admin Management Section");
        ...
        else
        {
            ...
            Admin_Logs.write("Access Denied - > Fail to Log In Admin Management Section");
        }
